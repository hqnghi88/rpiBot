            ...
            for msg_event in entry["messaging"]:
                ...
                if msg_event.get("message"):
                    ...
                    # Echo unrecognized commands
                        ...
                        fb.simple_msg(sender_id, str(response))
                        #os.system("espeak -ven+f3 -k5 -s150 '"+response+"'")
                        #else:
                           # search_results = google.search(message_text, 1)
                           # fb.simple_msg(sender_id, search_results[1].description)
